...
namespace Robit_Game
{
    public class OverWorld
    {
        ...
        void InitializeMap()
        {
            ...
            Map[28] = new WorldNode { Neighbors = new int[] {  2, 29, 27, 32 }, NeighborStoryReq = new int[] { 100, 100, 100, 100 }, EnemyTable = new int[] { 15, 15, 15, 15 }, Name = "Bitsburg Square - North",         DescriptionState = new int[] { 0, 999 }, Description = new string[] { "Test", "Error" } };
